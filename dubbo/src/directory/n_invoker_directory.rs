...
where
    ...
    <N as MakeService<DubboConfig, Url>>::Service: Service<Url, Response = Box<dyn Registry + Send + Sync + 'static>, Error = StdError>,
{
    
    type Response = InvokerDirectoryBuilder<<N as MakeService<DubboConfig, Url>>::Service>;
    type Error = StdError;
